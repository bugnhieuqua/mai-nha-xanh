            ...
            <div class="footer-content">
                ...
                <div class="footer-section">
                    ...
                    <ul class="footer-contact">
                        ...
                        <li><i class="fas fa-map-marker-alt"></i> <a href="https://maps.app.goo.gl/sSY9rKodfubWosh1A" target="_blank" rel="noopener" class="footer-map-link">Trường Đại học Kinh tế Nghệ An, TP. Vinh</a></li>
                    </ul>
                </div>
                ...
                <div class="footer-map">
                    <h3>Bản đồ</h3>
                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d51966.30698661654!2d105.6157091331863!3d18.6923405!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3139ce0e4264ec49%3A0x419cf16d3b928fa2!2zVHLGsOG7nW5nIMSQ4bqhaSBo4buNYyBLaW5oIHThur8gTmdo4buHIEFu!5e1!3m2!1svi!2s!4v1780655706906!5m2!1svi!2s"
                     width="100%" 
                     height="450" style="border:0; border-radius: 10px;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                </div>
            </div>
    ...
    <nav class="mobile-nav">
        ...
        <?php if (isset($_SESSION['user_id'])): ?>
            <a href="bai-dang-cua-toi.php" class="nav-item <?= basename($_SERVER['PHP_SELF']) == 'bai-dang-cua-toi.php' ? 'active' : '' ?>">
    ...
    @media (max-width: 768px) {
        .floating-post-btn {
            display: none !important; /* Hide on mobile because bottom nav has it */
        }
    }
    ...
    <!-- Terms Modal -->
    <div id="termsModal" class="modal-overlay" style="z-index: 10000; opacity: 0; pointer-events: none; transition: opacity 0.3s; display: flex; align-items: center; justify-content: center; background: rgba(0,0,0,0.6); position: fixed; top: 0; left: 0; right: 0; bottom: 0; padding: 15px;">
        <div class="modal-box" style="background: white; border-radius: 12px; max-width: 420px; width: 95%; padding: 18px; box-shadow: 0 10px 25px rgba(0,0,0,0.2); transform: translateY(-20px); transition: transform 0.3s; max-height: 70vh; display: flex; flex-direction: column; margin: auto;">
            <h3 style="margin-top:0; color: #1e293b; font-size: 1.1rem; margin-bottom: 12px; text-align: center;">Quy Định & Điều Khoản Sử Dụng</h3>
            <div style="font-size: 0.85rem; color: #475569; line-height: 1.5; overflow-y: auto; margin-bottom: 15px; flex: 1; padding: 0 5px;">
                <p style="margin-bottom: 10px;">Chào mừng bạn đến với Mái Nhà Xanh. Bằng việc truy cập sử dụng website, bạn cam kết tuân thủ các quy định cộng đồng sau:</p>
                <ul style="margin-left: 18px; margin-top: 8px; margin-bottom: 8px;">
                    <li style="margin-bottom: 6px;"><strong>Không đăng nội dung sai sự thật:</strong> Mọi bài đăng thuê trọ phải mô tả chính xác. Cố ý đăng sai sẽ bị khoá tài khoản.</li>
                    <li style="margin-bottom: 6px;"><strong>Không Spam hoặc lừa đảo:</strong> Các bình luận, tin nhắn nhằm mục đích lừa đảo, chửi bới, spam sẽ bị xử lý nghiêm.</li>
                    <li style="margin-bottom: 6px;"><strong>Cơ chế báo cáo:</strong> Người dùng có thể báo cáo các bài đăng hoặc tài khoản vi phạm. Ban quản trị sẽ kiểm tra và <strong>khoá vĩnh viễn (ban)</strong> các tài khoản vi phạm nghiêm trọng.</li>
                    <li style="margin-bottom: 6px;"><strong>Bảo mật:</strong> Các thông tin cá nhân của bạn sẽ được bảo mật theo quy định của pháp luật.</li>
                </ul>
                <p style="margin-bottom: 0;">Môi trường văn minh, an toàn là mục tiêu hàng đầu của chúng tôi!</p>
            </div>
            <div style="text-align: center;">
                <button id="acceptTermsBtn" class="btn btn-primary" style="padding: 9px 28px; border-radius: 6px; font-weight: 600; font-size: 0.9rem;">Tôi Đồng Ý</button>
            </div>
        </div>
    </div>
